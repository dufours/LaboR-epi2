...
library(knitr)
library(kableExtra)
kable(dp_data,  caption="**Table 6.1.** Nombre moyen estimé de jours jusqu’à la saillie fécondante pour chacune des catégories de parité et de dystocie")%>%
  kable_styling()
```
### Code R et réponses
Pour ce TP utilisez le fichier DAISY2 (voir description VER p.809).  
...
**a.**	Représentez graphiquement l’association entre milk120 et WPC. Pensez-vous qu’une ligne droite passant au travers des points capture adéquatement la relation entre ces deux variables ? 
```{r fig.cap="**Figure 6.6.** Relation entre la production de lait en 120j (milk120) et le nombre de jours jusqu’à la saillie fécondante (wpc) avec courbe lissée avec un facteur de 2.", warning=FALSE, message=FALSE}
library(ggplot2)
...
**b.**	Faites varier le lissage (e.g. 0.1 ou 1) et décrivez comment la courbe lissée change en fonction de ce lissage.  
```{r fig.cap="**Figure 6.7.** Relation entre la production de lait en 120j (milk120) et le nombre de jours jusqu’à la saillie fécondante (wpc) avec courbe lissée avec un facteur de 0.2.", warning=FALSE, message=FALSE}
...
**c.**	Maintenant, représentez graphiquement la relation entre parity et wpc. Dans ce cas, pensez-vous qu’une ligne droite passant au travers des points capture adéquatement la relation entre ces deux variables ? 
```{r fig.cap="**Figure 6.8.** Relation entre parité (parity) et le nombre de jours jusqu’à la saillie fécondante (wpc) avec courbe lissée avec un facteur de 2.", warning=FALSE, message=FALSE}
...
library(knitr)
library(kableExtra)
kable(dp_data2,  caption="**Table 6.2.** Nombre moyen estimé de jours jusqu’à la saillie fécondante pour chacune des catégories de parité et de dystocie")%>%
  kable_styling()
```
