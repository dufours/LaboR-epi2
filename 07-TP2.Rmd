...
```{r, fig.cap="**Figure 6.9.** Graphique Q-Q des résiduels."}
...
```{r, fig.cap="**Figure 6.10.** Graphique des résiduels x valeurs prédites."}
...
i.	Normalité des résiduels ?  
ii.	Homoscédasticité ?  
```{r, fig.cap="**Figure 6.11.** Graphique des résiduels x valeurs prédites."}
...
```
```{r, fig.cap="**Figure 6.12.** Graphique Q-Q des résiduels."}
...
i.	Normalité des résiduels ?  
ii.	Homoscédasticité ?  
```{r, fig.cap="**Figure 6.13.** Graphique des résiduels x valeurs prédites."}
...
```
```{r, fig.cap="**Figure 6.14.** Graphique Q-Q des résiduels."}
...
i.	Normalité des résiduels ?  
ii.	Homoscédasticité ?  
```{r, fig.cap="**Figure 6.15.** Graphique des résiduels x valeurs prédites."}
...
```
```{r, fig.cap="**Figure 6.16.** Graphique Q-Q des résiduels."}
...
```{r fig.cap="**Figure 6.17.** Relation entre taille de troupeau (herd_size) et le nombre de jours jusqu’à la saillie fécondante (wpc) avec courbe lissée avec un facteur de 2.", warning=FALSE, message=FALSE}
library(ggplot2)
...
```{r, fig.cap="**Figure 6.18.** Graphique des résiduels x valeurs prédites."}
...
plot(modele_final, 2)
```
```{r, fig.cap="**Figure 6.19.** Graphique Q-Q des résiduels."}
plot(modele_final, 1)
```
...
```{r, fig.cap="**Figure 6.20.** Relation entre résiduels standardisés et le nombre de jours jusqu’à la saillie fécondante (wpc) avec courbe lissée avec un facteur de 2.", message=FALSE, warning=FALSE}
library(ggplot2)
